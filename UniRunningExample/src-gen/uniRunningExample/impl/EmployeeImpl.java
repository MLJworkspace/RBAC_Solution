 ...
 * </p>
 * <ul>
 *   <li>{@link uniRunningExample.impl.EmployeeImpl#getEmpName <em>Emp Name</em>}</li>
 *   <li>{@link uniRunningExample.impl.EmployeeImpl#getEmpSurname <em>Emp Surname</em>}</li>
 *   <li>{@link uniRunningExample.impl.EmployeeImpl#getEmpExpertise <em>Emp Expertise</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EmployeeImpl extends MinimalEObjectImpl.Container implements Employee {
	...
	protected EClass eStaticClass() {
		return UniRunningExamplePackage.Literals.EMPLOYEE;
	}
	...
	public void setEmpName(String newEmpName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UniRunningExamplePackage.EMPLOYEE__EMP_NAME,
					oldEmpName, empName));
	}
	...
	public void setEmpSurname(String newEmpSurname) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UniRunningExamplePackage.EMPLOYEE__EMP_SURNAME,
					oldEmpSurname, empSurname));
	}
	...
	public void setEmpExpertise(String newEmpExpertise) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UniRunningExamplePackage.EMPLOYEE__EMP_EXPERTISE,
					oldEmpExpertise, empExpertise));
	}

...
/**
 * This is the item provider adapter for a {@link uniRunningExample_view.University} object.
 * <!-- begin-user-doc -->
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_University_uniName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_University_uniName_feature", "_UI_University_type"),
				 UniRunningExample_viewPackage.Literals.UNIVERSITY__UNI_NAME,
	...
	protected void addUniAddressPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_University_uniAddress_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_University_uniAddress_feature", "_UI_University_type"),
				 UniRunningExample_viewPackage.Literals.UNIVERSITY__UNI_ADDRESS,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			super.getChildrenFeatures(object);
				childrenFeatures.add(UniRunningExample_viewPackage.Literals.UNIVERSITY__DEPARTMENT);
		}
...
public Command createRemoveCommand(EditingDomain editingDomain, EObject owner, EStructuralFeature feature, Collection<?> collection) {
    if (owner instanceof University) {

...
/**
 * This is the item provider adapter for a {@link uniRunningExample.Partner} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PartnerItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addPartnerNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Partner_partnerName_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Partner_partnerName_feature",
								"_UI_Partner_type"),
						UniRunningExamplePackage.Literals.PARTNER__PARTNER_NAME, true, false, false,
	...
	protected void addPartnerTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Partner_partnerType_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Partner_partnerType_feature",
								"_UI_Partner_type"),
						UniRunningExamplePackage.Literals.PARTNER__PARTNER_TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Partner_type")

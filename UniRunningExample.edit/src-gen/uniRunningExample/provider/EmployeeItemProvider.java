...
/**
 * This is the item provider adapter for a {@link uniRunningExample.Employee} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EmployeeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addEmpNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Employee_empName_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Employee_empName_feature",
								"_UI_Employee_type"),
						UniRunningExamplePackage.Literals.EMPLOYEE__EMP_NAME, true, false, false,
	...
	protected void addEmpSurnamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Employee_empSurname_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Employee_empSurname_feature",
								"_UI_Employee_type"),
						UniRunningExamplePackage.Literals.EMPLOYEE__EMP_SURNAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addEmpExpertisePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Employee_empExpertise_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Employee_empExpertise_feature",
								"_UI_Employee_type"),
						UniRunningExamplePackage.Literals.EMPLOYEE__EMP_EXPERTISE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case UniRunningExamplePackage.EMPLOYEE__EMP_NAME:
		case UniRunningExamplePackage.EMPLOYEE__EMP_SURNAME:
		case UniRunningExamplePackage.EMPLOYEE__EMP_EXPERTISE:

...
/**
 * This is the item provider adapter for a {@link uniRunningExample.Project} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Project_projectName_feature",
								"_UI_Project_type"),
						UniRunningExamplePackage.Literals.PROJECT__PROJECT_NAME, true, false, false,
	...
	protected void addFundingAgencyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Project_fundingAgency_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Project_fundingAgency_feature",
								"_UI_Project_type"),
						UniRunningExamplePackage.Literals.PROJECT__FUNDING_AGENCY, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addProjectDurationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Project_projectDuration_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Project_projectDuration_feature",
								"_UI_Project_type"),
						UniRunningExamplePackage.Literals.PROJECT__PROJECT_DURATION, true, false, false,
	...
	protected void addProjectEmployeePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Project_projectEmployee_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Project_projectEmployee_feature",
								"_UI_Project_type"),
						UniRunningExamplePackage.Literals.PROJECT__PROJECT_EMPLOYEE, true, false, true, null, null,
						null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UniRunningExamplePackage.Literals.PROJECT__PARTNER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(UniRunningExamplePackage.Literals.PROJECT__PARTNER,
				UniRunningExampleFactory.eINSTANCE.createPartner()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return UniRunningExampleEditPlugin.INSTANCE;
	}

 ...
 * @generated
 */
public class UniRunningExample_viewSwitch {
	/**
	 ...
	 * @generated
	 */
	public UniRunningExample_viewSwitch() {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UniRunningExample_viewPackage.PROJECT: {
				Project project = (Project)theEObject;
				Object result = caseProject(project);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UniRunningExample_viewPackage.DEPARTMENT: {
				Department department = (Department)theEObject;
				Object result = caseDepartment(department);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UniRunningExample_viewPackage.PARTNER: {
				Partner partner = (Partner)theEObject;
				Object result = casePartner(partner);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UniRunningExample_viewPackage.EMPLOYEE: {
				Employee employee = (Employee)theEObject;
				Object result = caseEmployee(employee);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UniRunningExample_viewPackage.UNIVERSITY: {
